...
class RTMedia {
	...
	function enqueue_scripts_styles() {
		...
		wp_localize_script( 'rtmedia-main', 'rtmedia_media_delete_confirmation', apply_filter( 'rtmedia_delete_media_alert_message', esc_html__( 'Are you sure you want to delete this media?', 'buddypress-media' ) ) );
